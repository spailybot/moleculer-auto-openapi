...
> **⚠️ Moleculer 0.14 users:** versions up to **1.4.x** support Moleculer `0.14.x`. The next major
> releases target Moleculer `0.15.x`, so if you're on Moleculer `0.14` (or earlier), install the
> dedicated dist-tag to keep getting 0.14 fixes:
>
> ```
