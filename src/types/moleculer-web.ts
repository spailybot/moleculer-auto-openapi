...
import type { CallingOptions, LogLevels, Service } from 'moleculer';
...
export type onEventBusboyConfig<T> = unknown;
...
export type onBeforeCall = unknown;
export type onAfterCall = unknown;
...
export type routeMiddlewareError = unknown;

export type ETagFunction = unknown;
export type AliasFunction = unknown;
export type AliasRouteSchema = {
    [k: string]: any;
...
export type CommonSettingSchema = {
    /**
...
export type ApiSchemaAlias = string | AliasFunction | (AliasFunction | string)[] | AliasRouteSchema;
